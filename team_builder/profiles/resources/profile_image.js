(function() {
     ...
     *
     * This project is a bit messy and could be broken down further
     */
  ...
  // only create an imgElement if the picture is in the html
  if (imgElement) {
  ...
  let clearCanvas = $('clear-canvas');
     ...
     */
      ...
      // Creates a blank canvas sized to the siteImage
      let blankImage = new fabric.Rect({
        left: 0,
        top: 0,
        fill: 'white',
        width: siteImgWidth,
        height: siteImgHeight,
      });
  ...
  function removeSelected () {
     ...
     * Otherwise ignore
     */
    // Lets users tap the deleted button to get into move object mode
    turnOffDrawingMode();
